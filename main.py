...
def recomendar_sintoma(sintoma: str, api_key: str, top_margen: list | None = None) -> str:
    ...
    respuesta = cliente.messages.create(
        ...
        system=(
            ...
            "Tu PRIMERA opción debe ser SIEMPRE el producto que un farmacéutico vendería de "
            "verdad en el mostrador para ese síntoma (medicamento EFP sin receta o "
            "parafarmacia de uso común: p. ej. mucolítico/acetilcisteína, descongestionante "
            "tipo Vicks/Sinus, suero nasal, analgésico, antiácido...), AUNQUE no esté en la "
            "lista de margen y sin cifras de € ni CN. JAMÁS recomiendes como opción principal "
            "aparatos ni equipos (nebulizadores, humidificadores, difusores, irrigadores, "
            "tensiómetros, ortopedia): eso no se vende así en mostrador. "
